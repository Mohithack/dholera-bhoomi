export const PROJECTS = [
  ...
  {
    slug: 'himachal',
    name: 'Hill Retreat Estates',
    city: 'Himachal Pradesh',
    state: 'Himachal Pradesh',
    type: 'Hill Station Plots',
    status: 'coming-soon',
    cardHighlights: ['Scenic Mountain Views', 'Tourism & Wellness Zone', 'High Appreciation Potential'],
  },
  {
    slug: 'mohali',
    name: 'Mohali Smart Township',
    city: 'Mohali',
    state: 'Punjab',
    type: 'Residential Plots',
    status: 'coming-soon',
    cardHighlights: ['Near IT City Mohali', 'GMADA Approved Zone', 'Excellent Connectivity'],
  },
  {
    slug: 'goa',
    name: 'Coastal Living Goa',
    city: 'Goa',
    state: 'Goa',
    type: 'Residential & Villa Plots',
    status: 'coming-soon',
    cardHighlights: ['Beach Proximity', 'High Rental Yield', 'Tourism Growth Hub'],
  },
  {
    slug: 'noida',
    name: 'Noida Growth Corridor',
    city: 'Noida',
    state: 'Uttar Pradesh',
    type: 'Residential & Commercial',
    status: 'coming-soon',
    cardHighlights: ['Jewar Airport Proximity', 'Yamuna Expressway Belt', 'High ROI Zone'],
  },
  {
    slug: 'gurgaon',
    name: 'Gurgaon Elite Plots',
    city: 'Gurgaon',
    state: 'Haryana',
    type: 'Residential Plots',
    status: 'coming-soon',
    cardHighlights: ['NCR Prime Location', 'Corporate Hub Proximity', 'Premium Gated Township'],
  },
  {
    slug: 'ayodhya',
    name: 'Ayodhya Heritage Residences',
    city: 'Ayodhya',
    state: 'Uttar Pradesh',
    type: 'Residential Plots',
    status: 'coming-soon',
    cardHighlights: ['Ram Mandir Growth Zone', 'Tourism Boom Location', 'Government Development Drive'],
  },
];
